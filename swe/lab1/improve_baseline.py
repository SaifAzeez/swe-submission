...
# Classifier - Using Logistic Regression instead of Naive Bayes
...
params = {
    ...
    'solver': ['liblinear'],        # Solver for both L1 and L2 penalty
...
for repeated_time in range(REPEAT):
    ...
    tfidf = TfidfVectorizer(
        ngram_range=(1, 3),  # include up to 3-word n-grams
        max_features=2000,   # increase feature count
        min_df=3             # minimum document frequency to be included
    )
